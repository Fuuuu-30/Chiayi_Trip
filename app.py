...
DAY2_TEXT = (
    "【嘉義之旅 Day 2】\n\n"
    "09:00 飯店早餐\n"
    "10:00 臺灣花磚博物館 & 嘉義市立博物館 \n"
    "12:30 諸羅山涼麵 or 體育館壽司 \n"
    "13:30 興加臭豆腐 \n"
    "14:15 Archers Kitchen 弓箭手\n"
    "17:00 員林買手機\n"
    "18:00 回到溪湖家 \n\n"
...
SPOTS_INFO = {
    ...
    "崇文涼麵": (
        "🥗【崇文嘉義涼麵】\n"
        "傳承自 1956 年的在地傳統老店！全新風格空間舒適明亮，濃郁麻醬融合清爽白醋，醬汁完美附著在寬扁麵上，消暑必吃！\n\n"
        "⏰ 營業時間：11:00 - 20:00\n"
        "📍 必點推薦：嘉義白醋涼麵、皮蛋豆腐、涼菜\n"
        "🗺️ 地圖：https://maps.app.goo.gl/vpLEnaauWGLCuPg86"
    ),
    "文化路夜市": (
        "🍜【文化路夜市】\n"
        "嘉義夜間精華地帶，美食聚集地！\n\n"
    ...
    "Archers Kitchen 弓箭手": (
        "☕【Archers Kitchen 弓箭手】\n"
        "老宅改造的溫馨咖啡店，結合綠意種植營造出空間感，適合悠閒享受下午茶與甜點！\n\n"
        "⏰ 營業時間：09:00 - 17:00 (週二、週三公休)\n"
        "🗺️ 地圖：https://www.google.com/maps/search/?api=1&query=Archers Kitchen 弓箭手"
    ),
}
